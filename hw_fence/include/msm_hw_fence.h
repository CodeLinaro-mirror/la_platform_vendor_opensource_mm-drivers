 ...
 * @HW_FENCE_CLIENT_ID_NSP0: NSP0 Client 0.
 * @HW_FENCE_CLIENT_ID_NSP1: NSP1 Client 0.
 * @HW_FENCE_CLIENT_ID_NSP2: NSP2 Client 0.
 * @HW_FENCE_CLIENT_ID_NSP3: NSP3 Client 0.
...
enum hw_fence_client_id {
	...
	HW_FENCE_CLIENT_ID_NSP0 = HW_FENCE_CLIENT_ID_TEST4 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	HW_FENCE_CLIENT_ID_NSP1 = HW_FENCE_CLIENT_ID_NSP0 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	HW_FENCE_CLIENT_ID_NSP2 = HW_FENCE_CLIENT_ID_NSP1 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	HW_FENCE_CLIENT_ID_NSP3 = HW_FENCE_CLIENT_ID_NSP2 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
	/* txq only clients start from here */
	HW_FENCE_CLIENT_ID_IPA = HW_FENCE_CLIENT_ID_NSP3 + MSM_HW_FENCE_MAX_SIGNAL_PER_CLIENT,
